...
namespace TicketMachine.WS.Views
{
    ...
    /// </summary>
    public sealed partial class ReceiptsSplitPage : TicketMachine.WS.Common.LayoutAwarePage
    {
        public ReceiptsSplitPage()
        {
        ...
        protected override void SaveState(Dictionary<String, Object> pageState)
        {
            if (this.itemsViewSource.View != null)
            {
                ...
                //pageState["SelectedItem"] = (selectedItem as Receipt).TicketId;
            }
        }
        ...
        private void enlarge_barcode(object sender, RoutedEventArgs e)
        {
            ...
            Flyout f = new Flyout
            {
                ...
                Content = new LargeBarcode(Convert.ToString((selectedItem as Receipt).Barcode)),
                IsOpen = true
            };
        }
