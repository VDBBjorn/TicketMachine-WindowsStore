...
namespace TicketMachine.WS.Views
{
    ...
    /// </summary>
    public sealed partial class LoyaltyCardDetailPage : TicketMachine.WS.Common.LayoutAwarePage
    {
        public LoyaltyCardDetailPage()
        {
        ...
        private void enlarge_barcode(object sender, RoutedEventArgs e)
        {
            ...
            Flyout f = new Flyout
            {
                ...
                Content = new LargeBarcode(Convert.ToString((selectedItem as LoyaltyCard).Barcode)),
                IsOpen = true
            };
        }
    }
